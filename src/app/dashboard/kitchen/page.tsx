      ...
      {displayOrders.length === 0 ? (
       ...
       {newOrderToast && (
         <div
           role="alert"
           aria-live="assertive"
           className="fixed bottom-10 right-6 z-[9999] flex items-start gap-3 rounded-2xl border border-[var(--brand-orange)]/30 bg-white dark:bg-zinc-900 shadow-2xl p-4 w-80 animate-in slide-in-from-bottom-2 fade-in duration-300"
         >
