...
export default function AiHelpChat() {
  ...
  const floatingButton = (
    <button
      type="button"
      onClick={openChat}
      className="fixed bottom-24 right-4 sm:right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[var(--brand-orange)] text-white shadow-lg transition hover:bg-[var(--brand-orange-hover)] focus:outline-none focus:ring-2 focus:ring-[var(--brand-orange)] focus:ring-offset-2"
